          ...
          <form style="margin-top: 1.5rem;" action="" method="post">
            ...
            <div style="margin-bottom: 1.75rem;">
              ...
              <div class="d-flex w-100 div-input-content-3-9">
                ...
                <input class="input-field-content-3-9" type="text" name="phone_number" id="" placeholder="Your Phone Number" autocomplete="on" required>
              </div>
            </div>
            <div style="margin-top: 1rem;">
              ...
              <div class="d-flex w-100 div-input-content-3-9">
                ...
                <input class="input-field-content-3-9" type="password" name="password" id="" placeholder="Your Password" minlength="6" required>
                <div>
