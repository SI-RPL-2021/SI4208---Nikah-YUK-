...
if (isset($_POST['register1'])) {
  ...
  $tambahuser = mysqli_query($conn, "insert into login (namalengkap, email, password, notelp) 
    ...
    <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-9">
        ...
        <div class="right-content-3-9">
          ...
          <h3 class="title-text-content-3-9">Sign Up</h3>
          <p class="caption-text-content-3-9">Please register your account<br>
            on the website.</p>
          <form style="margin-top: 1.5rem;" action="" method="post">
            <div style="margin-bottom: 1.75rem;">
              <label for="" class="d-block input-label-content-3-9">Full Name</label>
              <div class="d-flex w-100 div-input-content-3-9">
                ...
                <input class="input-field-content-3-9" type="text" name="nama" id="" placeholder="Your Full Name" autocomplete="on" required>
              </div>
            </div>
            <div style="margin-bottom: 1.75rem;">
              ...
              <div class="d-flex w-100 div-input-content-3-9">
                ...
                <input class="input-field-content-3-9" type="email" name="email" id="" placeholder="Your Email Address" autocomplete="on" required>
              </div>
            </div>
            <div style="margin-bottom: 1.75rem;">
              <label for="" class="d-block input-label-content-3-9">Phone Number</label>
              <div class="d-flex w-100 div-input-content-3-9">
                <!-- <svg class="icon-content-3-9" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M5 5C3.34315 5 2 6.34315 2 8V16C2 17.6569 3.34315 19 5 19H19C20.6569 19 22 17.6569 22 16V8C22 6.34315 20.6569 5 19 5H5ZM5.49607 7.13174C5.01655 6.85773 4.40569 7.02433 4.13168 7.50385C3.85767 7.98337 4.02427 8.59422 4.50379 8.86823L11.5038 12.8682C11.8112 13.0439 12.1886 13.0439 12.4961 12.8682L19.4961 8.86823C19.9756 8.59422 20.1422 7.98337 19.8682 7.50385C19.5942 7.02433 18.9833 6.85773 18.5038 7.13174L11.9999 10.8482L5.49607 7.13174Z" fill="#CACBCE" />
                </svg> -->
                <input class="input-field-content-3-9" type="text" name="telp" id="" placeholder="Your Phone Number" autocomplete="on" required>
              </div>
            </div>
            <div style="margin-top: 1rem;">
              ...
              <div class="d-flex w-100 div-input-content-3-9">
                ...
                <input class="input-field-content-3-9" type="password" name="pass" id="" placeholder="Your Password" minlength="6" required>
                <div>
            ...
            <button class="btn btn-fill-content-3-9 d-block w-100" type="submit" name="register1">Sign Up My Account</button>
          </form>
          <p class="text-center bottom-caption-content-3-9">Do you have account ?
            <a href="Login.php"><span class="green-bottom-caption-content-3-9"> Login Here</span> </a>
          </p>
