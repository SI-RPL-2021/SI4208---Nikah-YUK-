...
<head>
    ...
    <title>Tutorial - Nikah-YUK!</title>
</head>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo-header-4-2">
                    <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="tutorial_user.php">Tutorial</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Blog_user.php">Blog</a>
                        </li>
                ...
                <div class="inner">
                    ...
                    <div class="row">
                        <div class="card" style="width: 26rem;">
                            <img src="../../img/foto11.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"> TIPS makeup PEMULA : rahasia anti crack, anti cakey, tahan lama ala MUA</h5>
                                <p class="card-text">Baru pertama kali belajar make up ?? terus takut jadi luntur atau cakey ?? klik button ini biar kamu dapat pengalaman make up baru !!!!</p>
                                <a href="https://www.youtube.com/watch?v=aGtqpnOVHCU" class="btn btn-success">Go somewhere</a>
                            </div>
                        </div>
                        <div class="card" style="width: 26rem;">
                            <img src="../../img/foto22.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">7 Tips Tepat Memilih Makeup Bahan Natural Supaya Tampil Lebih Flawless</h5>
                                <p class="card-text">gaya riasan alami yang memberi kesan tidak berlebihan sedang menjadi tren. ini tips buat kamu untuk memilik make up natural tapi tetap flawless.</p>
                                <a href="https://www.risal.info/7-tips-tepat-memilih-makeup-bahan-natural-supaya-tampil-lebih-flawless.html" class="btn btn-success">Go somewhere</a>
                            </div>
                        </div>
                        <div class="card" style="width: 26rem;">
                            <img src="../../img/pomade.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">CARA PAKAI POMADE YANG BENAR !! AGAR RAMBUT TIDAK RUSAK. BARBERSHOP</h5>
                                <p class="card-text">Terkadang penggunaan pomade yang salah bisa bikin rambut lepek dan berketombe. ini tips menggunakan pomade dengan benar supaya ga salah lagi nih !!.</p>
                                <a href="https://www.youtube.com/watch?v=JeZGRqPFI1Q" class="btn btn-success">Go somewhere</a>
                            </div>
                        </div>
                        <div class="card" style="width: 26rem;">
                            <img src="../../img/foto4.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">7 Tips dan Cara Memakai Eyeliner Untuk Mata Sipit dan Monolid agar tampik menarik</h5>
                                <p class="card-text">memakai eyeliner untuk mata sipit butuh latihan dan ada triknya sendiri. Ini beberapa tips dan cara memakai eyeliner untuk mata sipit atau monolid.</p>
                                <a href="https://today.line.me/id/v2/article/q9jpqW" class="btn btn-success">Go somewhere</a>
                            </div>
                        </div>
