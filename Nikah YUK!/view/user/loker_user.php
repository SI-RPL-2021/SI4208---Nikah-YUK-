                    ...
                    <div class="row">
                        <div class="col">
                            <div class="testimonial">
                                <img src="../../img/loker1.jpg" alt="">
                                <div class="name">photographer</div>
                                <p>
                                    Photographers tend to specialise in one particular area of photography such as press and photo journalism, fashion or scientific and medical photography.
                                </p>
                                <a class="btn btn-success" href="loker1_user.php" role="button">see details</a>
                        ...
                        <div class="col">
                            <div class="testimonial">
                                <img src="../../img/loker2.jpg" alt="">
                                <div class="name">Make-Up Artist</div>
                                <p>
                                    A makeup artist is someone who uses cosmetic techniques and processes to create beauty upon the human body. In its simplest form, it enhances a person's...
                                </p>
                                <a class="btn btn-success" href="loker2_user.php" role="button">see details</a>
                            </div>
                        ...
                        <div class="col">
                            <div class="testimonial">
                                <div class="testi-avatar"><img src="../../img/loker3.jpg" alt="">
                                    <div class="name">Database Administrator</div>
                                    <p>
                                        use specialized software to store and organize data. The role may include capacity planning, installation, configuration, database,...
                                    </p>
                                    <a class="btn btn-success" href="loker3_user.php" role="button">see details</a>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Vacancy Form</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="modal-body">
                                    <form method="post" action="../../controller/send_loker.php">
                                        ...
                                        <div class="form-group">
                                            <label for="nilai">Phone number : </label>
                                            <input type="number" name="number" id="number" class="form-control" required>
                                        </div>
                                        <label> Select Education : </label><br><br>
                                        <select name="major">
