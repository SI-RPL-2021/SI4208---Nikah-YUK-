...
<head>
    ...
    <title>Faq - Nikah-YUK!</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
    <script>document.getElementsByTagName("html")[0].className += " js";</script>
    <link rel="stylesheet" href="../../style/faq.css">
    <!-- <link rel="stylesheet" href="../style/faq2.scss"> -->
        ...
        <div class="header-4-2" style="font-family: 'Poppins', sans-serif;">
            ...
            <section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
                <ul class="cd-faq__categories">
                    ...
                    <li><a class="cd-faq__category truncate" href="#account">Payments</a></li>
                    <li><a class="cd-faq__category truncate" href="#payments">Nikah-Yuk!!</a></li>
                ...
                <div class="cd-faq__items">
                    <ul id="basics" class="cd-faq__group">
                        ...
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Bagaimana cara membuat akun ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Anda dapat membuat akun dengan mengklik tombol SIGN UP kemudian anda dapat mengisi data-data pribadi untuk keperluan registrasi</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Apakah data pada akun saya langsung dapat digunakan saat pemesanan nantinya ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Data pada akun pelanggan akan disimpan dan nantinya dapat digunakan pada pemesan paket ataupun layanan yang kami sediakan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Dapatkah saya memiliki lebih dari 1 akun ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Setiap pelanggan dianjurkan untuk menggunakan hanya 1 akun saja. Tetapi jika anda membuat akun untuk kerabat ataupun untuk bisnis, tetap diperbolehkan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Dapatkah akun saya digunakan oleh pasangan saya ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Akun yang digunakan dapat digunakan oleh tiap pasangan, untuk menghindari adanya pemesanan paket yang redundan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
                    </ul> <!-- cd-faq__group -->
                    ...
                    <ul id="mobile" class="cd-faq__group">
                        <li class="cd-faq__title"><h2>Services</h2></li>
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Apa saja layanan yang diberikan oleh website ini ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Website Nikah-Yuk!! merupakan website Wedding Organizer yang memberikan layanan berupa gedung pernikahan, katering, undangan, wedding car, photographer, wardrobe, decoration, concept dan banyak hal lainnya. Website ini juga menyediakan lowongan pekerjaan bagi orang yang ingin bergabung di Wedding Organizer Nikah-Yuk!!.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Apakah saya bisa berkoordinasi langsung dengan para vendor terkait?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Nikah-Yuk!! menyediakan layanan wedding organizer dimana kami akan mengatur dan merencanakan pernikahan pasangan sesuai dengan konsep anda. Oleh karena itu, kami akan menghandle bagian vendor agar tidak merepotkan para pasangan. Tetapi, hal itu tidak menutup kemungkinan komunikasi yang terjadi antar pasangan dan vendor yang ada.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
                        
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Untuk booking sebaiknya berapa lama sebelum hari-H ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Pasangan dapat terlebih dahulu untuk memilih paket ataupun layanan yang telah disediakan. Untuk waktu booking akan diinfokan lewat kontak pribadi ataupun dapat berkonsultasi terlebih dahulu dengan kontak yang telah disediakan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Bagaimana saya dapat memilih layanan yang cocok bagi pernikahan saya ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Rencana pernikahan para pasangan dapat dikonsultasikan pada halaman konsultasi yang telah disediakan. Halaman konsultasi berisikan kontak-kontak konsultan wedding yang dapat dihubungi para pasangan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
                    </ul> <!-- cd-faq__group -->
                    ...
                    <ul id="account" class="cd-faq__group">
                        ...
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Bagaimana metode pembayaran yang dilakukan?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Untuk pembayaran, kami hanya menyediakan nomor rekening dan kemudian pelanggan dapat membayar dengan segala metode yang dianggap memudahkan pasangan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Berapa kira-kira biaya pernikahan standar yang pernah Anda tangani ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Biaya yang keluarkan cukup relatif tergantung paket ataupun layanan yang pasangan pilih, jadi tidak ada biaya standar yang menjadi tetapan dari website ini.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Bisa dibuat sesuai budget saya tidak?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Tentu saja bisa. Oleh karena itu, kami menyediakan halaman konsultasi dimana pasangan dapat berkonsultasi mengenai konsep pernikahan ataupun budget yang akan disesuaikan dengan konsep pernikahan pasangan. </p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Bagaimana caranya agar saya bisa mengetahui price list dari vendor-vendor di NIKAH-YUK ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Anda dengan mudah mengetahui harga setiap layanan dengan mengklik fitur service ataupun choose plan agar dapat mengetahui daftar harga yang disediakan..</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
                    </ul> <!-- cd-faq__group -->
                    ...
                    <ul id="payments" class="cd-faq__group">
                        <li class="cd-faq__title"><h2>Nikah-Yuk!!</h2></li>
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Dimanakah Wedding Organizer ini berada/berpusat ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Wedding Organizer Nikah-Yuk! berlokasi di Kabupaten Bojongsoang, Bandung dekat dengan Telkom University.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Berapa banyak event pernikahan yang sudah kalian tangani ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Kami telah menangani kurang lebih 450 pernikahan yang ada sejak Wedding Organizer ini berdiri tahun 2018.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
            
                        <li class="cd-faq__item">
                            <a class="cd-faq__trigger" href="#0"><span>Apakah Wedding Organizer ini menerima kerja sama dengan vendor baru ?</span></a>
                            <div class="cd-faq__content">
                      <div class="text-component">
                        <p>Wedding Organizer Nikah-Yuk terbuka untuk seluruh vendor yang dapat berkerja sama dengan baik di bagian pernikahan.</p>
                      </div>
                            </div> <!-- cd-faq__content -->
                        </li>
                    </ul> <!-- cd-faq__group -->
