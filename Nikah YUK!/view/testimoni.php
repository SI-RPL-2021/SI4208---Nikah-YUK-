        ...
        <div class="header-4-2" style="font-family: 'Poppins', sans-serif;">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo-header-4-2">
                    ...
                    <a href="Login.php"><button class="btn btn-default btn-no-fill-header-2-2">LogIn</button></a>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="testimonial">
                        ...
                        <p>
                            Awalnya agak ragu mau coba menggunakan Nikah-Yuk tapi pas ambil vendor undangannya desainnya bagus banget dan bahan kertasnya juga tebal, selain itu harganya standar,
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="testimonial">
                        ...
                        <p>
                          MUA nya baik banget, datengnya ontime juga tau yang sesuai sama warna kulit dan bikin makeupnya kelihatan natural,dan yang pasti make-up nya awet banget tahan ga luntur,
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="testimonial">
                        ...
                        <p> Wow engga nyangka dekorasi dan gedungnya sebagus ini awalnya sempet pusing juga nyari vendor buat gedung tapi pake Nikah-Yuk dapet yang bagus banget dan kelihatan mewah banget,</p>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="testimonial">
                        ...
                        <p>
                          Terimakasih banyak buat Photographernya sabar dan ngarahin fotonya juga bagus jadi ngga terlalu banyak ngulang juga, selain itu banyak memberi ide buat kita tanpa harus bingung lagi,
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="testimonial">
                        ...
                        <p>
                          Coba pake Nikah-yuk buat gaun pernikahan dan bagus banget hasilnya, jahitannya juga rapi, bahannya enak banget dipakai seharian tanpa gerah sama sekali. Terimakasih Nikah-yuk!!!! ,
                        </p>
                      </div>
                    </div>
                    ...
                    <h3>Tekan Button untuk memberikan testimoni</h3>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Berikan Testimoni Terbaik Anda </button>
